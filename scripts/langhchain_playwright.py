...
if __name__ == "__main__":
    ...
    for s in graph.stream({"messages": [("user", f"Try apply for this job for the candidate: https://www.linkedin.com/jobs/view/4203903356. Try to extract the job description and find the apply button")]}, stream_mode="values"):
